...
class PerlinRoadGenerator: public RoadGenerator {
 public:
   ...
   * @param length The length of the generated road. Gets scaled with scale_x
   * @param grid_size The size of the grid for perlin noise generation, higher = more consitent terrain
   ...
   * @param scale_x Stretches out the road horizontally. The higher, the more gentle the slopes
   */
