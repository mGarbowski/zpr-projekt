/**
 * @brief Unit tests for CarDescription
...
TEST( CarDescription, throwsIfPointsAreNotConstrainedToXYAxes ) {
  ...
  EXPECT_THROW( CarDescription( top_left, Position{ 0.1, 1 }, top_right, right, bottom_right,
                                bottom, bottom_left, left, body_density, rear_wheel_density,
                                front_wheel_density, rear_wheel_radius, front_wheel_radius ),
                std::invalid_argument );

  EXPECT_THROW( CarDescription( top_left, top, top_right, { 1, 0.1 }, bottom_right, bottom,
...
TEST( CarDescription, throwsIfCornerPointsAreNotRestrictedToQuadrants ) {
  // top_left, top_right, bottom_right, bottom_left points must be restricted to their respective
  // quadrants
  const Position top_left = { -1, 1 };
  const Position top = { 0, 1 };
  const Position top_right = { 1, 1 };
  ...
  EXPECT_THROW( CarDescription( { 0.1, 1 }, top, top_right, right, bottom_right, bottom,
                                bottom_left, left, body_density, rear_wheel_density,
                                front_wheel_density, rear_wheel_radius, front_wheel_radius ),
                std::invalid_argument );
  EXPECT_THROW( CarDescription( { -1, -0.1 }, top, top_right, right, bottom_right, bottom,
                                bottom_left, left, body_density, rear_wheel_density,
                                front_wheel_density, rear_wheel_radius, front_wheel_radius ),
                std::invalid_argument );
  EXPECT_THROW( CarDescription( { 0.1, -0.1 }, top, top_right, right, bottom_right, bottom,
                                bottom_left, left, body_density, rear_wheel_density,
                                front_wheel_density, rear_wheel_radius, front_wheel_radius ),
                std::invalid_argument );

  EXPECT_THROW( CarDescription( top_left, top, { -0.1, 1 }, right, bottom_right, bottom,
                                bottom_left, left, body_density, rear_wheel_density,
                                front_wheel_density, rear_wheel_radius, front_wheel_radius ),
                std::invalid_argument );
  EXPECT_THROW( CarDescription( top_left, top, { 1, -0.1 }, right, bottom_right, bottom,
                                bottom_left, left, body_density, rear_wheel_density,
                                front_wheel_density, rear_wheel_radius, front_wheel_radius ),
                std::invalid_argument );
  EXPECT_THROW( CarDescription( top_left, top, top_right, { -0.1, -0.1 }, bottom_right, bottom,
                                bottom_left, left, body_density, rear_wheel_density,
                                front_wheel_density, rear_wheel_radius, front_wheel_radius ),
                std::invalid_argument );
...
TEST( CarDescription, equalityOperator ) {
  const Position top_left = { -1, 1 };
  const Position top = { 0, 1 };
  const Position top_right = { 1, 1 };
  const Position right = { 1, 0 };
  ...
  const auto car_description_1 = CarDescription(
      top_left, top, top_right, right, bottom_right, bottom, bottom_left, left, body_density,
      rear_wheel_density, front_wheel_density, rear_wheel_radius, front_wheel_radius );

  const auto car_description_2 = CarDescription(
      top_left, top, top_right, right, bottom_right, bottom, bottom_left, left, body_density,
      rear_wheel_density, front_wheel_density, rear_wheel_radius, front_wheel_radius );

  const auto car_description_3 = CarDescription(
      top_left, top, top_right, right, bottom_right, bottom, bottom_left, left, body_density,
      rear_wheel_density, front_wheel_density, rear_wheel_radius, front_wheel_radius + 1 );

  EXPECT_EQ( car_description_1, car_description_2 );
  EXPECT_FALSE( car_description_1 == car_description_3 );
}
